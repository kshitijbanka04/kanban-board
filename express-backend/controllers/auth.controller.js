...
exports.logIn = async (req, res) => {
	try {
		...
		if (!user) return res.status(409).json({ messagxe: 'no account was registered with this email' }).end()
...
const generateJwt = (payload) => jwt.sign(payload, "your_secret_key_here", { expiresIn: '15d' })
